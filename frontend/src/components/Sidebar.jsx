    ...
    return (
        <div className="flex flex-col h-full">
            <div className="flex items-center justify-between px-5 py-4 border-b border-stone-100">
                ...
                {onClose && (
                    <button onClick={onClose} className="lg:hidden text-stone-400 hover:text-stone-700 p-1">
                        <LuX size={20} />
                    </button>
                )}
            </div>
            ...
            <div className="p-3 border-t border-stone-100">
                <div className="bg-stone-50 rounded-xl px-3 py-3 mb-2">
                ...
                <button
                    ...
                    className="w-full flex items-center gap-2 px-3 py-2 rounded-xl text-stone-500 hover:text-red-500 hover:bg-red-50 text-sm font-medium transition"
                >
                    <LuLogOut size={15} />
                    Sign out
                </button>
    ...
    return (
        <>
            <button
                ...
                className="lg:hidden fixed top-4 left-4 z-50 bg-white border border-stone-200 text-stone-700 p-2 rounded-xl shadow-md"
            ...
            <aside
                className={`
          fixed top-0 left-0 h-full w-64 bg-white border-r border-stone-100 z-50 shadow-sm flex flex-col
          transform transition-transform duration-300 ease-in-out
          ${open ? 'transtone-x-0' : '-transtone-x-full'}
          lg:sticky lg:top-0 lg:h-screen lg:transtone-x-0 lg:shrink-0
        `}
            >
